...
const Navbar = () => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo to='/'>
          <img src="https://res.cloudinary.com/drdjty87p/image/upload/v1724943417/WhatsApp_Image_2024-08-29_at_8.22.35_PM-removebg-preview_zhmjwv.png" className='port' />
